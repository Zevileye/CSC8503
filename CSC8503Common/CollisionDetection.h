...
static const int layerNomal = 0;
static const int layerPlayer = 1;
static const int layerEnemy = 2;
static const int layerCacheable = 3;

extern void AddIgnoreLayer(int layer1, int layer2);
