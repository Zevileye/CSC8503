...
void NCL::CSC8503::TutorialGame::InitialiseScene()
{
...
GameObject* TutorialGame::InitDefaultFloor() {
	return AddFloorToWorld(Vector3(0, -2, 0));
}
		...
		if (world->Raycast(ray, closestCollision, true)) {
			if (closestCollision.node == selectionObject) {
				selectionObject->GetPhysicsObject()->AddForceAtPosition(
					ray.GetDirection() * forceMagnitude * 10.0f,
